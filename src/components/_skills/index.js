    ...
    return (
      <Fade bottom className='skill'>
        <SkillsCard cardTitle='User Experience' iconSrc={ IconHexagon }>
            I believe empathy helps create better experiences. By defining painpoints, behavior and expectations, we give the user a voice which provides guidance in design. Meaningful results are often achieved by listening - not by what's trending.
        </SkillsCard>
      </Fade>
    );
  }
