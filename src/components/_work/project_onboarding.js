    ...
    return (
      <Modal
        ...
        <Modal.Detail subtitle='Context'>
          Gusto, formerly ZenPayroll, was a startup with an onboarding experience designed for those who were already sold on payroll. It had been years since this flow was touched. With the widening user base, it became a major strain to the funnel of customers coming in who simply wanted to browse the product. The goal was to introduce the brand while progressively demonstrating value and building trust. NBD. While this was the primary goal, I had a secondary goal of reducing the need for manual data entry. Integrations introduced an opportunity for automation, and increased probability of feature adoption.
        </Modal.Detail>
        <Modal.Detail subtitle='Design'>
          This was one of the largest projects I've completed at Gusto. It required major collaboration with multiple internal teams, including growth, risk, engineering, and more. Onboarding required research on multiple fronts since it heavily touched entry points at the landing page, pricing, navigation, dashboard and promotional content. The full requirements for being ready to run the first payroll were steep. It asked for business registration from Federal, state and local agencies, liability signoffs, paystub history, each team member's details including personal information, compensation, withholding preferences, contacts, and more. According to the teams focused on migration, it could take up to a week or more to fully onboard. This project broke the onboarding requirements down into contextual, educational stages that would be more digestable for the user. With the massive scope of this project, it was necessary to break it down by phases and slow rollouts.
        </Modal.Detail>
