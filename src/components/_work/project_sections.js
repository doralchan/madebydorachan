    ...
    return (
      <Modal
        ...
        <Modal.Detail subtitle='Design'>
          After highlighting key sections, we interviewed a handful of customers about each task and observed them entering data in. Everything was done through excel spreadsheets. They often went back and forth in files, and needed to reference resources found in paperwork. We tried to minimize this manual work in each and every section.
        </Modal.Detail>
      </Modal>
    )
  }
